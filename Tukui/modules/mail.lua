...
----------------------------------------------------------------------------------------
local L_MAIL_STOPPED = tukuilocal.mail_inventoryfull
local L_MAIL_COMPLETE = tukuilocal.mail_done
local L_MAIL_NEED = tukuilocal.mail_mailneed
local L_MAIL_MESSAGES = tukuilocal.mail_messages
